...
const LessonItem = ({ lesson, slug, isActive,completed }: isAppProps) => {
    ...
    <Link
      ...
      className={buttonVariants({
        ...
        className: cn(
          ...
          isActive &&
            !completed &&
            "border-primary/50 bg-primary/10 text-primary hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30"
        ),
      })}
    >
